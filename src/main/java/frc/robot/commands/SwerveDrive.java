...
public class SwerveDrive extends CommandBase {
    ...
    public SwerveDrive(SwerveDrivetrain s_Swerve, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, BooleanSupplier robotCentricSup) {
    ...
    public void execute() {
        ...
        /* Drive */
        s_Swerve.drive(
            new Translation2d(translationVal, strafeVal).times(Constants.MAX_SPEED), 
            rotationVal * Constants.MAX_ANGULAR_VELOCITY, 
